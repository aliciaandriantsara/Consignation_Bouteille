...
function isLoggedIn(): bool {
    ...
    //contenant les vairables SESSION de php lorsqu'une session est demarree a l'aide de start_session() dans public/index.php
...
function redirect(string $path): void {
    ...
    //Quand le navigateur demande http://localhost/consigne/public/index.php/auth/login, apache reconnait que index.php est le fichier reel et que auth/login est juste une information supplementaire collee ares
